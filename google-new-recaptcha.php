...
add_action( 'wpcf7_init', 'register_cf7');
...
function register_cf7() {
    ...
    if (function_exists('wpcf7_add_shortcode')) {
        ...
        wpcf7_add_shortcode( 'norecaptcha', 'shortcode_handler', true );
...
add_shortcode( 'nocaptcha', 'nocaptcha_fn' );
